#THIS IS EXAMPLE OF CODE THAT NEEDS REFACTORING
#Main takeaway is that my code previously is very repetitive
#Needs abstracting into functions
#Good first draft but needs work
#Otherwise keep the order the same, and avoid literals
...
class RefactorExample(wx.Frame):
    ...
    def __init__(self, parent, id):
        ...
        #BUTTONS created here, and twice seperately below
        ...
        #This could be ordered much better, and too much repetition
        menuBar = wx.MenuBar()
        menu1 = wx.Menu()
