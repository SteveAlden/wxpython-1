#To Use : (with existing wxPython scripts)
#c:\Python**/Scripts\pywrap.bat minimal.py
#Can manipulate once import wx
#Referred to in pycrust as app
#CTRL+UP to recall previous input lines
